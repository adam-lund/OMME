...
#' @title Print Function for objects of Class OMME
#'
#' @description This function will print some information about the OMME object.
#'
#' @param x a OMME object
#' @param ... ignored
#'
#' @examples
#'
...
print.OMME <- function(x, ...) {
out <- data.frame(kappa = x$sparsity, Df = x$df, lambda = x$lambda)
print(out)
}
